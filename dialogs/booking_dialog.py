...
class BookingDialog(CancelAndHelpDialog):
    ...
    def __init__(
        ...
        patterns = ['{dst_city}', '{or_city}', '{str_date}', '{end_date}', '{budget}'] # placeholders de la card
    ...
    async def confirm_step(
        ...
        msg = (
            ...
            and the return on {end_date}. Your budget is {booking_details.budget}$ "
        )
    ...
    def log_performances(self, properties: dict, success:str):
        ...
        if not os.path.exists(self.performance_path):
            with open(self.performance_path, "w") as f:
                f.write("turns, dst_city, or_city, dep_date, ret_date, budget, success\n")
        
        with open(self.performance_path, "a") as f:
            f.write("{}, {}, {}, {}, {}, {}, {}\n".format(" | ".join(properties["Turns"]), properties["Destination"], properties["Origin"], properties["Start_date"], properties["End_date"], properties["Budget"], success))
